...
class ProjectUpdate extends Component {
    constructor(props) {
        super(props);
        this.state = {
            projectUpdateId: Object.values(props.match.params)[0],
            date: "",
            checklists: "",
            achievements: "",
            problems: "",
        ...
        this.handleProjectUpdateData = this.handleProjectUpdateData.bind(this);
    }
    ...
    handleProjectUpdateData() {
        axios.get(`/ProjectUpdate/${this.state.projectUpdateId}`)
            ...
            .catch(err => console.log('error project update data: ', err))
    }
